...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "TITS";
    public static final String ACCOUNT_PREFIX = "TITS";
    public static final String PROJECT_NAME  = "TiTSCoin";
    ...
    public static final long MAX_BALANCE_NXT = 100000000000000000L;
    public static final long ONE_NXT = 1L;
    public static final long FEE_NXT = 500L;
